    ...
    public class DynamicGameObject : EAGLPhysicsObject
    {
        ...
        public override Vector3 GravityValues
        {
            get
            {
                ...
                var x = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_X_POS + offset + 30);
                var y = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_Y_POS + offset + 30);
                var z = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_Y_POS + offset + 30);
        ...
        public override Vector3 Position
        {
            ...
            {
                var addr = (int)Memory.getBaseAddress;
                var x = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_X_POS + offset);
                var y = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_Y_POS + offset);
                var z = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_Z_POS + offset);
        ...
        public override Quaternion Rotation
        {
            get
            {
                var x = Memory.ReadFloat((IntPtr)PlayerAddrs.STATIC_PLAYER_X_ROT + offset);
                var y = Memory.ReadFloat((IntPtr)PlayerAddrs.STATIC_PLAYER_Y_ROT + offset);
                var z = Memory.ReadFloat((IntPtr)PlayerAddrs.STATIC_PLAYER_Z_ROT + offset);
                var w = Memory.ReadFloat((IntPtr)PlayerAddrs.STATIC_PLAYER_W_ROT + offset);
        ...
        public override Vector3 RotationAxis
        {
            ...
            {
                var addr = (int)Memory.getBaseAddress;
                var x = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_X_POS + offset + 0x20);
                var y = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_X_POS + offset + 0x24);
                var z = Memory.ReadFloat((IntPtr)addr + PlayerAddrs.NON_STATIC_PLAYER_X_POS + offset + 0x28);
